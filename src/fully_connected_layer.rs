...
impl FullyConnectedLayer {
    ...
    pub fn new(input_width: usize, input_depth: usize, output_size: usize) -> FullyConnectedLayer {
        ...
        let normal =
            Normal::new(0.0, (2.0 / (input_size.pow(2) * input_depth) as f32).sqrt()).unwrap();
